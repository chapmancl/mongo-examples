...
#from local_settings import settings # change this to use lmig_settings
...
logging.getLogger("mongomcp.mongodb_client").setLevel(logging.DEBUG)
logging.getLogger("mongomcp.memory").setLevel(logging.DEBUG)
logging.getLogger("mongomcp.memory.tools").setLevel(logging.DEBUG)
